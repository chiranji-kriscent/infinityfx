...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group col-md-3">
                        <label class="font-weight-bold"><?php echo app('translator')->get('APP TIMEZONE'); ?></label>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group col-lg-3 col-md-6">
                        <label class="d-block"><?php echo app('translator')->get('Cron Set Up Pop Up'); ?></label>
                        <div class="custom-switch-btn">
                    ...
                    <div class="form-group col-sm-3 ">
                        <label class="font-weight-bold"><?php echo app('translator')->get('Debug Mode'); ?></label>
                        <div class="custom-switch-btn">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\infinityfx\resources\views/admin/basic-controls.blade.php ENDPATH**/ ?>