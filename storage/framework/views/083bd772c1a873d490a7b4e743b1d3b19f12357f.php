<aside class="left-sidebar" data-sidebarbg="skin6">
            ...
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item">
                    ...
                    <a class="sidebar-link" href="#" aria-expanded="false">
                        ...
                        <span class="hide-menu"><?php echo app('translator')->get('Role'); ?></span>
                    </a>
                </li>
                <?php endif; ?>
                ...
                <li class="sidebar-item <?php echo e(menuActive(['admin.investments*'],3)); ?>">
                    <a class="sidebar-link" href="<?php echo e(route('admin.investments')); ?>" aria-expanded="false">
                        ...
                        <span class="hide-menu"><?php echo app('translator')->get('Trade Investments'); ?></span>
                    </a>
                </li>
                <?php endif; ?>
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link" href="<?php echo e(route('admin.scheduleManage')); ?>" aria-expanded="false">
                        ...
                        <span class="hide-menu"><?php echo app('translator')->get('Trade Closing'); ?></span>
                    </a>
                </li>
                <li class="list-divider"></li>
                <li class="sidebar-item <?php echo e(menuActive(['admin.planList','admin.planCreate','admin.planEdit*'],3)); ?>">
                    <a class="sidebar-link" href="<?php echo e(route('admin.planList')); ?>" aria-expanded="false">
                        ...
                        <span class="hide-menu"><?php echo app('translator')->get('Investment Limit'); ?></span>
                    </a>
                </li>
                <?php endif; ?>
                    ...
                    <ul aria-expanded="false" class="collapse first-level base-level-line">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="<?php echo e(route('admin.commissions')); ?>" aria-expanded="false">
                                ...
                                <span class="hide-menu"><?php echo app('translator')->get('Team Commission'); ?></span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="<?php echo e(route('admin.commissions')); ?>" aria-expanded="false">
                                <i class="fas fa-money-bill-alt"></i>
                                <span class="hide-menu"><?php echo app('translator')->get('Joinig Referral'); ?></span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="<?php echo e(route('admin.commissions')); ?>" aria-expanded="false">
                                <i class="fas fa-money-bill-alt"></i>
                                <span class="hide-menu"><?php echo app('translator')->get('Trade Profit'); ?></span>
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link has-arrow" href="javascript:void(0)" aria-expanded="false">
                        ...
                        <span class="hide-menu"><?php echo app('translator')->get('Wallet'); ?></span>
                    </a>
                    <ul aria-expanded="false" class="collapse first-level base-level-line">
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="<?php echo e(route('admin.transaction')); ?>" aria-expanded="false">
                                <i class="fa fa-credit-card"></i>
                                <span class="hide-menu"><?php echo app('translator')->get('Credit'); ?></span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="<?php echo e(route('admin.commissions')); ?>" aria-expanded="false">
                                <i class="fa fa-credit-card"></i>
                                <span class="hide-menu"><?php echo app('translator')->get('Debit'); ?></span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="<?php echo e(route('admin.commissions')); ?>" aria-expanded="false">
                                <i class="fas fa-history"></i>
                                <span class="hide-menu"><?php echo app('translator')->get('History'); ?></span>
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link has-arrow" href="javascript:void(0)" aria-expanded="false">
                        <i class="fas fa-money-bill-alt"></i>
                        <span class="hide-menu"><?php echo app('translator')->get('Withdrawal'); ?></span>
                    </a>
                    <ul aria-expanded="false" class="collapse first-level base-level-line">
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="<?php echo e(route('admin.payout-method')); ?>" aria-expanded="false">
                                <i class="fas fa-credit-card"></i>
                                <span class="hide-menu"><?php echo app('translator')->get('Withdrawal Request'); ?></span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="<?php echo e(route('admin.payout-request')); ?>" aria-expanded="false">
                                <i class="fas fa-hand-holding-usd"></i>
                                <span class="hide-menu"><?php echo app('translator')->get('Withdrawal Accept'); ?></span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="<?php echo e(route('admin.payout-log')); ?>" aria-expanded="false">
                                <i class="fas fa-history"></i>
                                <span class="hide-menu"><?php echo app('translator')->get('Withdrawal History'); ?></span>
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link has-arrow" href="javascript:void(0)" aria-expanded="false">
                        ...
                        <span class="hide-menu"><?php echo app('translator')->get('Tickets'); ?></span>
                    </a>
                    <ul aria-expanded="false" class="collapse first-level base-level-line">
                        <li class="sidebar-item">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="<?php echo e(route('admin.ticket',['open'])); ?>" aria-expanded="false">
                                <i class="fas fa-spinner"></i>
                                <span class="hide-menu"><?php echo app('translator')->get('Open Ticket'); ?></span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="<?php echo e(route('admin.ticket',['closed'])); ?>" aria-expanded="false">
                                <i class="fas fa-times-circle"></i>
                                <span class="hide-menu"><?php echo app('translator')->get('Closed Ticket'); ?></span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="<?php echo e(route('admin.ticket',['answered'])); ?>" aria-expanded="false">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link" href="#" aria-expanded="false">
                        ...
                        <span class="hide-menu"><?php echo app('translator')->get('Reports'); ?></span>
                    </a>
                </li>
                <li class="list-divider"></li>
                <li class="sidebar-item">
                    <a class="sidebar-link" href="<?php echo e(route('admin.email-send')); ?>" aria-expanded="false">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link has-arrow" href="javascript:void(0)" aria-expanded="false">
                        <i data-feather="file-text" class="feather-icon"></i>
                        <span class="hide-menu"><?php echo app('translator')->get('KYC Setting'); ?></span>
                    </a>
                    <ul aria-expanded="false" class="collapse first-level base-level-line">
                    ...
                    <li class="sidebar-item">
                        ...
                        <?php endif; ?>
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="<?php echo e(route('admin.kyc.users.pending')); ?>" aria-expanded="false">
                                <i class="fas fa-spinner"></i>
                                <span class="hide-menu"><?php echo app('translator')->get('Pending KYC'); ?></span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="<?php echo e(route('admin.kyc.users')); ?>" aria-expanded="false">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link has-arrow" href="javascript:void(0)" aria-expanded="false">
                        <i class="fas fa-credit-card"></i>
                        <span class="hide-menu"><?php echo app('translator')->get('Payment Setting'); ?></span>
                    </a>
                    <ul aria-expanded="false" class="collapse first-level base-level-line">
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="<?php echo e(route('admin.payment.methods')); ?>" aria-expanded="false">
                                <i class="fas fa-credit-card"></i>
                                <span class="hide-menu"><?php echo app('translator')->get('Payment Methods'); ?></span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="<?php echo e(route('admin.deposit.manual.index')); ?>" aria-expanded="false">
                    ...
                    <ul aria-expanded="false" class="collapse first-level base-level-line">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="<?php echo e(route('admin.breadcrumb')); ?>" aria-expanded="false">
                                ...
                                <span class="hide-menu"><?php echo app('translator')->get('Manage Breadcrumb'); ?></span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link has-arrow" href="javascript:void(0)" aria-expanded="false">
                ...
                <li class="sidebar-item <?php echo e(menuActive(['admin.language.create','admin.language.edit*','admin.language.keywordEdit*'],3)); ?>">
                    <a class="sidebar-link" href="<?php echo e(route('admin.language.index')); ?>" aria-expanded="false">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link has-arrow" href="javascript:void(0)" aria-expanded="false">
                        <i class="fas fa-image"></i>
                        <span class="hide-menu"><?php echo app('translator')->get('Manage Theme'); ?></span>
                    </a>
                    <ul aria-expanded="false" class="collapse first-level base-level-line">
                        <li class="sidebar-item">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="<?php echo e(route('admin.logo-seo')); ?>" aria-expanded="false">
                                <i class="fas fa-image"></i>
                                <span class="hide-menu"><?php echo app('translator')->get('Manage Logo & SEO'); ?></span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="<?php echo e(route('admin.breadcrumb')); ?>" aria-expanded="false">
                ...
                <li class="sidebar-item <?php echo e(menuActive(['admin.template.show*'],3)); ?>">
                    ...
                    <ul aria-expanded="false" class="collapse first-level base-level-line <?php echo e(menuActive(['admin.template.show*'],1)); ?>">
                        ...
                        <li class="sidebar-item <?php echo e(menuActive(['admin.template.show'.$name])); ?>">
                            <a class="sidebar-link <?php echo e(menuActive(['admin.template.show'.$name])); ?>" href="<?php echo e(route('admin.template.show',$name)); ?>">
                ...
                <li class="sidebar-item <?php echo e(menuActive(['admin.content.create','admin.content.show*'],3)); ?>">
                    ...
                    <ul aria-expanded="false" class="collapse first-level base-level-line <?php echo e(menuActive(['admin.content.create','admin.content.show*'],1)); ?>">
                        ...
                        <li class="sidebar-item <?php echo e(($last == $name) ? 'active' : ''); ?> ">
                            <a class="sidebar-link <?php echo e(($last == $name) ? 'active' : ''); ?>" href="<?php echo e(route('admin.content.index',$name)); ?>">
                                <span class="hide-menu"><?php echo app('translator')->get(ucfirst(kebab2Title($name))); ?></span>
                            </a>
                        </li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <!-- End Sidebar scroll-->
</aside><?php /**PATH C:\xampp\htdocs\laravel\infinityfx\resources\views/admin/layouts/sidebar.blade.php ENDPATH**/ ?>