        ...
        <div class="row justify-content-between ">
            ...
            <div class="col-md-5">
                <div class="card card-primary shadow">
                        <div class="card-body">
                            <form method="post" action="<?php echo e(route('admin.referral-commission.action')); ?>" class="form-row align-items-center justify-content-between">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="form-group col-md-4">
                                    <label class="font-weight-bold"><?php echo app('translator')->get('Upline Deposit Bonus'); ?></label>
                ...
                <div class="card card-primary shadow">
                    <div class="card-body">
                        ...
                        <h5 class="card-title"><?php echo app('translator')->get('Funding Bonus'); ?></h5>
                        <div class="table-responsive">
                            <table class="categories-show-table table table-hover table-striped table-bordered"
                                   id="zero_config">
                                <thead class="thead-dark">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/infinityfx/resources/views/admin/plan/referral-commission.blade.php ENDPATH**/ ?>