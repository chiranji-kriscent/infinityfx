                            ...
                            <a
                                ...
                                data-route="<?php echo e(route('admin.login-as-user',$user->id)); ?>">
                                 <span class="btn-label">
                                    <i class="fas fa-sign-in-alt"></i></span> <?php echo app('translator')->get('Login as User'); ?>
                            </a>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/infinityfx/resources/views/admin/users/edit-user.blade.php ENDPATH**/ ?>