<?php if(isset($templates['faq'][0]) && $faq = $templates['faq'][0]): ?>
                ...
                <div class="row">
                    <div class="col">
                        <div class="header-text text-center">
                            <h5><?php echo app('translator')->get(@$faq->description->title); ?></h5>
                            <h2><?php echo app('translator')->get(@$faq->description->sub_title); ?></h2>
                            <p><?php echo app('translator')->get(@$faq->description->short_details); ?></p>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="accordion-item mb-4">
                                        ...
                                        <div id="collapse<?php echo e($k); ?>"
                                            ...
                                            <div class="accordion-body">
                                                <p><?php echo trans(@$data->description->description); ?></p>
                                            </div>
                                        </div>
                                    </div>
    ...
    <?php endif; ?>
<?php endif; ?>
<?php /**PATH /opt/lampp/htdocs/infinityfx/resources/views/themes/deepblack/sections/faq.blade.php ENDPATH**/ ?>