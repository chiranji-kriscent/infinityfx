                ...
                <div class="card card-primary shadow">
                    <div class="card-body">
                        <?php if(adminAccessRoute(config('role.payment_gateway.access.add'))): ?>
                            <a href="<?php echo e(route('admin.deposit.manual.create')); ?>" class="btn btn-success btn-sm float-right mb-3"><i class="fa fa-plus-circle"></i> <?php echo e(trans('Add New')); ?></a>
                        <?php endif; ?>
                                ...
                                <?php $__currentLoopData = $methods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $method): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr data-code="<?php echo e($method->code); ?>">
                                        ...
                                        <td data-label="<?php echo app('translator')->get('Status'); ?>">
                                            ...
                                            <?php echo $method->status == 1 ? '<span class="badge badge-success badge-pill">'.trans('Active').'</span>' : '<span class="badge badge-danger badge-sm">'.trans('Inactive').'</span>'; ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/infinityfx/resources/views/admin/payment_methods/manual/index.blade.php ENDPATH**/ ?>