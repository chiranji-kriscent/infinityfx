        ...
        <div class="row justify-content-between ">
            ...
            <div class="col-md-5">
                <div class="card card-primary shadow">
                        <div class="card-body">
                            <form method="post" action="{{route('admin.referral-commission.action')}}" class="form-row align-items-center justify-content-between">
                                @csrf
                                ...
                                <div class="form-group col-md-4">
                                    <label class="font-weight-bold">@lang('Upline Deposit Bonus')</label>
